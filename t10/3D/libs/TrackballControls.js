...
THREE.TrackballControls = function ( object, domElement ) {
	...
	function mousemove( event ) {
		...
		var deltaX = event.clientX - lastMousePositionX;
		var deltaY = event.clientY - lastMousePositionY;
		for (var count = 0; count < objects.length; count++)
		{
			objects[count].position.x = objects[count].position.x + deltaX;
			objects[count].position.y = objects[count].position.y - deltaY;
		}
		lastMousePositionX = event.clientX;
		lastMousePositionY = event.clientY;	
	/*
		...
		*/
				...
				if(currentActiveObj &&currentActiveObj.rotationMode)
		{
			...
			if(currentActiveObj)
			{
				currentActiveObj.rotation.x = (tgtRotX - currentActiveObj.rotation.x)*0.05;
				currentActiveObj.rotation.y = (tgtRotY - currentActiveObj.rotation.y)*0.05;
			}
		}
