...
THREE.Matrix4.prototype = {
    ...
    getInverse: function (a) {
        ...
        b[2] = i * o * s - l * n * s + l * m * t - h * o * t - i * m * c + h * n * c;
        ...
        p = function (h, i, j) {
            if (h instanceof a.Particle) {
                ...
                for (var G = 0, P = o.faces.length; G < P; G++) {
                    ...
                    if (void 0 !== l && (l = l.side, e.sub(B.centroid, c), u = B.normal, v = d.dot(u), !(Math.abs(v) < C) && (u = u.dot(e) / v, !(0 > u) && (l === a.DoubleSide || (l === a.FrontSide ? 0 > v : 0 < v))))) if (f.add(c, d.multiplyScalar(u)), B instanceof a.Face3) l = p[B.a], v = p[B.b], u = p[B.c], n(f, l, v, u) && (v = h.matrixWorld.multiplyVector3(f.clone()), l = b.distanceTo(v), l < i.near || l > i.far || j.push({
                        distance: l,
                        point: v,
                        face: B,
                        faceIndex: G,
...
THREE.Projector = function () {
    ...
    this.projectScene = function (g, h, m, Q) {
        var Z = h.near,
            L = h.far,
            oa = !1,
            X, fa, ca, Y, ba, aa, ia, Aa, Na, Ja, ma, sa, Ea, rb, ib;
        u = q = t = p = 0;
        G.elements.length = 0;
        g.updateMatrixWorld();
            ...
            for (var c = 0, d = b.children.length; c < d; c++) {
                ...
                if (!1 !== f.visible) {
                    if (f instanceof THREE.Light) G.lights.push(f);
                        ...
                        if (!1 === f.frustumCulled || !0 === N.contains(f)) e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : (P.copy(f.matrixWorld.getPosition()), K.multiplyVector3(P), e.z = P.z), G.objects.push(e)
        ...
        g = 0;
        for (m = G.objects.length; g < m; g++) if (Aa = G.objects[g].object, Na = Aa.matrixWorld, j = 0, Aa instanceof THREE.Mesh) {
            Ja = Aa.geometry;
            ca = Ja.vertices;
            ma = Ja.faces;
            Ja = Ja.faceVertexUvs;
            ...
            X = 0;
            for (fa = ca.length; X < fa; X++) i = b(), i.positionWorld.copy(ca[X]), Na.multiplyVector3(i.positionWorld), i.positionScreen.copy(i.positionWorld), K.multiplyVector4(i.positionScreen), i.positionScreen.x /= i.positionScreen.w, i.positionScreen.y /= i.positionScreen.w, i.visible = i.positionScreen.z > Z && i.positionScreen.z < L;
            ca = 0;
            for (X = ma.length; ca < X; ca++) if (fa = ma[ca], ib = !0 === Ea ? rb.materials[fa.materialIndex] : Aa.material, void 0 !== ib) {
                aa = ib.side;
                if (fa instanceof THREE.Face3) if (Y = l[fa.a], ba = l[fa.b], ia = l[fa.c], !0 === Y.visible && !0 === ba.visible && !0 === ia.visible) if (oa = 0 > (ia.positionScreen.x - Y.positionScreen.x) * (ba.positionScreen.y - Y.positionScreen.y) - (ia.positionScreen.y - Y.positionScreen.y) * (ba.positionScreen.x - Y.positionScreen.x), aa === THREE.DoubleSide || oa === (aa === THREE.FrontSide)) p === s ? (sa = new THREE.RenderableFace3, o.push(sa), s++, p++, n = sa) : n = o[p++], n.v1.copy(Y), n.v2.copy(ba), n.v3.copy(ia);
                else continue;
                else continue;
...
THREE.Geometry.prototype = {
    ...
    computeTangents: function () {
        ...
        var b, c, d, e, f, g, h, i, j, l, m, n, p, o, s, t, r, z, w, q, E, A, v, u, D = [],
            C = [],
            G = new THREE.Vector3,
            P = new THREE.Vector3,
            B = new THREE.Vector3,
        ...
        for (c = this.faces.length; b < c; b++) {
            f = this.faces[b];
            for (d = 0; d < f.vertexNormals.length; d++) H.copy(f.vertexNormals[d]), e = f[I[d]], u = D[e], B.copy(u), B.subSelf(H.multiplyScalar(H.dot(u))).normalize(), K.cross(f.vertexNormals[d], u), e = K.dot(C[e]), e = 0 > e ? -1 : 1, f.vertexTangents[d] = new THREE.Vector4(B.x, B.y, B.z, e)
        }
        this.hasTangents = !0
    },
...
THREE.BufferGeometry.prototype = {
    ...
    computeVertexNormals: function () {
        if (this.attributes.position && this.attributes.index) {
            ...
            for (d = e.length; c < d; ++c) {
                ...
                var w = e[c].index;
                a = b;
                for (b += i; a < b; a += 3) i = w + f[a], j = w + f[a + 1], l = w + f[a + 2], m = g[3 * i], n = g[3 * i + 1], p = g[3 * i + 2], o.set(m, n, p), m = g[3 * j], n = g[3 * j + 1], p = g[3 * j + 2], s.set(m, n, p), m = g[3 * l], n = g[3 * l + 1], p = g[3 * l + 2], t.set(m, n, p), r.sub(t, s), z.sub(o, s), r.crossSelf(z), h[3 * i] += r.x, h[3 * i + 1] += r.y, h[3 * i + 2] += r.z, h[3 * j] += r.x, h[3 * j + 1] += r.y, h[3 * j + 2] += r.z, h[3 * l] += r.x, h[3 * l + 1] += r.y, h[3 * l + 2] += r.z
            }
    ...
    computeTangents: function () {
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv) console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");
            ...
            var l, m, n, p, o, s, t, r, z, w, q, E, A, v, u, f = new THREE.Vector3,
                g = new THREE.Vector3,
                D, C, G, P, B, K, H, I = this.offsets;
            G = 0;
            for (P = I.length; G < P; ++G) {
                ...
                var N = I[G].index;
                D = C;
                for (C += B; D < C; D += 3) B = N + b[D], K = N + b[D + 1], H = N + b[D + 2], l = c[3 * B], m = c[3 * B + 1], n = c[3 * B + 2], p = c[3 * K], o = c[3 * K + 1], s = c[3 * K + 2], t = c[3 * H], r = c[3 * H + 1], z = c[3 * H + 2], w = e[2 * B], q = e[2 * B + 1], E = e[2 * K], A = e[2 * K + 1], v = e[2 * H], u = e[2 * H + 1], p -= l, l = t - l, o -= m, m = r - m, s -= n, n = z - n, E -= w, w = v - w, A -= q, q = u - q, u = 1 / (E * q - w * A), f.set((q * p - A * l) * u, (q * o - A * m) * u, (q * s - A * n) * u), g.set((E * l - w * p) * u, (E * m - w * o) * u, (E * n - w * s) * u), i[B].addSelf(f), i[K].addSelf(f), i[H].addSelf(f), j[B].addSelf(g), j[K].addSelf(g), j[H].addSelf(g)
            }
            ...
            for (P = I.length; G < P; ++G) {
                ...
                N = I[G].index;
                D = C;
                for (C += B; D < C; D += 3) B = N + b[D], K = N + b[D + 1], H = N + b[D + 2], a(B), a(K), a(H)
            }
...
THREE.BinaryLoader.prototype.createBinModel = function (a, b, c, d) {
    var e = function () {
        ...
        function G(b, c, d) {
            for (var e, f, g, h, i, c = new Uint32Array(a, c, 4 * b), j = new Uint16Array(a, d, b), d = 0; d < b; d++) e = c[4 * d], f = c[4 * d + 1], g = c[4 * d + 2], h = c[4 * d + 3], i = j[d], K.faces.push(new THREE.Face4(e, f, g, h, null, null, i))
        }
        function P(b, c, d, e) {
            for (var f, g, h, i, j, l, n, c = new Uint32Array(a, c, 3 * b), d = new Uint32Array(a, d, 3 * b), m = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                ...
                var s = I[3 * n],
                    r = I[3 * n + 1];
                n = I[3 * n + 2];
                K.faces.push(new THREE.Face3(f, g, h, [new THREE.Vector3(I[3 * j], I[3 * j + 1], I[3 * j + 2]), new THREE.Vector3(o, p, l), new THREE.Vector3(s, r, n)], null, i))
            }
        }
        function B(b, c, d, e) {
            for (var f, g, h, i, j, l, n, m, o, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), p = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                ...
                var u = I[3 * o],
                    v = I[3 * o + 1];
                o = I[3 * o + 2];
                K.faces.push(new THREE.Face4(f, g, h, i, [new THREE.Vector3(I[3 * l], I[3 * l + 1], I[3 * l + 2]), new THREE.Vector3(s, r, n), new THREE.Vector3(q, t, m), new THREE.Vector3(u, v, o)], null, j))
            }
        }
        var K = this,
            H = 0,
        ...
        q && (w = d + 4 * q * Uint32Array.BYTES_PER_ELEMENT, t = w + 4 * q * Uint32Array.BYTES_PER_ELEMENT, B(q, d, w, t + 4 * q * Uint32Array.BYTES_PER_ELEMENT), D(q, t));
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
    var d = new THREE.Geometry,
        ...
        f, g, h, i, j, l, m, n, p, o, s, t, r, z, w, q = a.faces;
    o = a.vertices;
    var E = a.normals,
        A = a.colors,
        v = 0;
    ...
    for (j = q.length; i < j;) {
        ...
        s = o & 64;
        o &= 128;
        l ? (t = new THREE.Face4, t.a = q[i++], t.b = q[i++], t.c = q[i++], t.d = q[i++], l = 4) : (t = new THREE.Face3, t.a = q[i++], t.b = q[i++], t.c = q[i++], l = 3);
        ...
        if (m) for (f = 0; f < l; f++) n = 3 * q[i++], g = new THREE.Vector3, g.x = E[n++], g.y = E[n++], g.z = E[n], t.vertexNormals.push(g);
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    function f(a, b) {
        for (var c in b) if (void 0 === M.objects[c]) {
            ...
            if (e.type && e.type in l.hierarchyHandlerMap && void 0 === e.loading) {
                ...
                n.addEventListener ? (n.addEventListener("load", h(c, a, C, e)), n.load(d(e.url, Q.urlBaseType))) : n.options ? n.load(d(e.url, Q.urlBaseType), h(c, a, C, e)) : n.load(d(e.url, Q.urlBaseType), h(c, a, C, e), i)
                ...
                if (D = M.geometries[e.geometry]) {
                    ...
                    g.name = c;
                    r ? (g.matrixAutoUpdate = !1, g.matrix.set(r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[12], r[13], r[14], r[15])) : (g.position.set(w[0], w[1], w[2]), E ? (g.quaternion.set(E[0], E[1], E[2], E[3]), g.useQuaternion = !0) : g.rotation.set(q[0], q[1], q[2]), g.scale.set(A[0], A[1], A[2]));
                    g.visible = e.visible;
            ...
            } else "DirectionalLight" === e.type || "PointLight" === e.type || "AmbientLight" === e.type ? (H = void 0 !== e.color ? e.color : 16777215, I = void 0 !== e.intensity ? e.intensity : 1, "DirectionalLight" === e.type ? (w = e.direction, K = new THREE.DirectionalLight(H, I), K.position.set(w[0], w[1], w[2]), e.target && (J.push({
                object: K,
                targetName: e.target
            }), K.target = null)) : "PointLight" === e.type ? (w = e.position, z = e.distance, K = new THREE.PointLight(H, I, z), K.position.set(w[0], w[1], w[2])) : "AmbientLight" === e.type && (K = new THREE.AmbientLight(H)), a.add(K), K.name = c, M.lights[c] = K, M.objects[c] = K) : "PerspectiveCamera" === e.type || "OrthographicCamera" === e.type ? ("PerspectiveCamera" === e.type ? G = new THREE.PerspectiveCamera(e.fov, e.aspect, e.near, e.far) : "OrthographicCamera" === e.type && (G = new THREE.OrthographicCamera(v.left, v.right, v.top, v.bottom, v.near, v.far)), w = e.position, G.position.set(w[0], w[1], w[2]), a.add(G), G.name = c, M.cameras[c] = G, M.objects[c] = G) : (w = e.position, q = e.rotation, E = e.quaternion, A = e.scale, E = 0, g = new THREE.Object3D, g.name = c, g.position.set(w[0], w[1], w[2]), E ? (g.quaternion.set(E[0], E[1], E[2], E[3]), g.useQuaternion = !0) : g.rotation.set(q[0], q[1], q[2]), g.scale.set(A[0], A[1], A[2]), g.visible = void 0 !== e.visible ? e.visible : !1, a.add(g), M.objects[c] = g, M.empties[c] = g);
            if (g) {
                if (void 0 !== e.properties) for (var m in e.properties) g.properties[m] = e.properties[m];
    ...
    var l = this,
        ...
        n, p, o, s, t, r, z, w, q, E, A, v, u, D, C, G, P, B, K, H, I, N, O, R, ga, M, J = [],
        Q = a,
        Z;
    ...
    if (Q.transform && (Z = Q.transform.position, a = Q.transform.rotation, c = Q.transform.scale, Z && M.scene.position.set(Z[0], Z[1], Z[2]), a && M.scene.rotation.set(a[0], a[1], a[2]), c && M.scene.scale.set(c[0], c[1], c[2]), Z || a || c)) M.scene.updateMatrix(), M.scene.updateMatrixWorld();
    Z = function (a) {
        return function () {
            O -= a;
            j();
    ...
    for (n in Q.geometries) t = Q.geometries[n], t.type in this.geometryHandlerMap && (N += 1, l.onLoadStart());
    ...
    for (n in Q.geometries) if (t = Q.geometries[n], "cube" === t.type) D = new THREE.CubeGeometry(t.width, t.height, t.depth, t.widthSegments, t.heightSegments, t.depthSegments), M.geometries[n] = D;
    ...
    else if ("sphere" === t.type) D = new THREE.SphereGeometry(t.radius, t.widthSegments, t.heightSegments), M.geometries[n] = D;
        ...
        this.geometryHandlerMap[t.type].loaderObject.load(d(t.url, Q.urlBaseType), g(n), L)
    ...
    for (s in Q.textures) {
        ...
        if (n.url instanceof Array) {
            ...
            if (n.repeat && (B.repeat.set(n.repeat[0], n.repeat[1]), 1 !== n.repeat[0] && (B.wrapS = THREE.RepeatWrapping), 1 !== n.repeat[1])) B.wrapT = THREE.RepeatWrapping;
...
THREE.CanvasRenderer = function (a) {
    ...
    var a = a || {},
        ...
        v = null,
        u = null,
        D, C, G, P, B = new THREE.RenderableVertex,
        K = new THREE.RenderableVertex,
        H, I, N, O, R, ga, M, J, Q, Z, L, oa, X = new THREE.Color,
        fa = new THREE.Color,
        ca = new THREE.Color,
        Y = new THREE.Color,
        ba = new THREE.Color,
        ...
        Aa = {},
        Na = {},
        Ja, ma, sa, Ea, rb, ib, ob, jb, Bb, Cb, Wa = new THREE.Rectangle,
    ...
    this.clear = function () {
        ...
        !1 === Sa.isEmpty() && (Sa.minSelf(Wa), Sa.inflate(2), 1 > r && s.clearRect(Math.floor(Sa.getX()), Math.floor(Sa.getY()), Math.floor(Sa.getWidth()), Math.floor(Sa.getHeight())), 0 < r && (c(THREE.NormalBlending), b(1), e("rgba(" + Math.floor(255 * t.r) + "," + Math.floor(255 * t.g) + "," + Math.floor(255 * t.b) + "," + r + ")"), s.fillRect(Math.floor(Sa.getX()), Math.floor(Sa.getY()), Math.floor(Sa.getWidth()), Math.floor(Sa.getHeight()))), Sa.empty())
    };
        ...
        if (!1 === l instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            if (!0 === kb) {
                ...
                for (zc = i.length; $b < zc; $b++) {
                    da = i[$b];
                    var la = da.color;
                    da instanceof THREE.AmbientLight ? (Oa.r += la.r, Oa.g += la.g, Oa.b += la.b) : da instanceof THREE.DirectionalLight ? (lb.r += la.r, lb.g += la.g, lb.b += la.b) : da instanceof THREE.PointLight && (ab.r += la.r, ab.g += la.g, ab.b += la.b)
                }
            }
            $b = 0;
...
THREE.WebGLRenderer = function (a) {
    ...
    function d(a, b) {
        ...
        if (a.numMorphTargets) {
            ...
            c = 0;
            for (l = a.numMorphTargets; c < l; c++) a.__morphTargetsArrays.push(new Float32Array(3 * i))
        }
        ...
        if (d.attributes) {
            ...
            for (var o in d.attributes) {
                var j = d.attributes[o],
                    ...
                    p;
                for (p in j) c[p] = j[p];
                if (!c.__webglInitialized || c.createUniqueBuffers) c.__webglInitialized = !0, h = 1, "v2" === c.type ? h = 2 : "v3" === c.type ? h = 3 : "v4" === c.type ? h = 4 : "c" === c.type && (h = 3), c.size = h, c.array = new Float32Array(i * h), c.buffer = k.createBuffer(), c.buffer.belongsToAttribute = o, j.needsUpdate = !0, c.__original = j;
    ...
    function i(a, b, c) {
        ...
        if (s) {
            i = 0;
            for (j = s.length; i < j; i++) if (h = s[i], h.needsUpdate || c.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.bufferData(k.ARRAY_BUFFER, h.array, b)
        }
    }
    function j(a, b, c) {
        var d = a.attributes,
    ...
    function q(a, b, c, d, e) {
        ...
        if (f) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (mb) {
                    for (var l = 0, n = 0, m = 0, o, p, s, r = sb, q = r.directional.colors, t = r.directional.positions, w = r.point.colors, z = r.point.positions, A = r.point.distances, B = r.spot.colors, C = r.spot.positions, D = r.spot.distances, G = r.spot.directions, X = r.spot.anglesCos, J = r.spot.exponents, K = r.hemi.skyColors, Q = r.hemi.groundColors, M = r.hemi.positions, O = 0, ca = 0, N = 0, R = 0, ia = 0, Z = 0, ba = 0, ga = 0, qa = p = 0, c = qa = qa = 0, f = b.length; c < f; c++) j = b[c], j.onlyShadow || (o = j.color, s = j.intensity, p = j.distance, j instanceof THREE.AmbientLight ? j.visible && (L.gammaInput ? (l += o.r * o.r, n += o.g * o.g, m += o.b * o.b) : (l += o.r, n += o.g, m += o.b)) : j instanceof THREE.DirectionalLight ? (ia += 1, j.visible && (p = 3 * O, L.gammaInput ? v(q, p, o, s * s) : u(q, p, o, s), xa.copy(j.matrixWorld.getPosition()), xa.subSelf(j.target.matrixWorld.getPosition()), xa.normalize(), t[p] = xa.x, t[p + 1] =
                ...
                if (m = j, j = E(), k.uniform1i(f, j), m) if (m.image instanceof Array && 6 === m.image.length) {
                    if (c = m, f = j, 6 === c.image.length) if (c.needsUpdate) {
                        ...
                        for (l = 0; 6 > l; l++) if (f) {
                            t = j[l].mipmaps;
                            w = 0;
                            for (z = t.length; w < z; w++) q = t[w], k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, w, m, q.width, q.height, 0, q.data)
    ...
    this.domElement =
    I;
	//if(this.domElement.width == 300)
	//	this.domElement.width = 10000;
    ...
    zb = k.getExtension("EXT_texture_filter_anisotropic") || k.getExtension("MOZ_EXT_texture_filter_anisotropic") || k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
    ...
    this.renderBuffer = function (a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            ...
            if (!d.morphTargets && 0 <= b.position) a && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), k.vertexAttribPointer(b.position, 3, k.FLOAT, !1, 0, 0));
                ...
                c = d.program.attributes; - 1 !== f.morphTargetBase ? (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[f.morphTargetBase]), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0)) : 0 <= c.position && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0));
                if (f.morphTargetForcedOrder.length) {
                    var i = 0;
                    h = f.morphTargetForcedOrder;
                    for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length;) k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[h[i]]), k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[h[i]]), k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0)), f.__webglMorphTargetInfluences[i] = g[h[i]], i++
                } else {
                    h = [];
                    ...
                    for (i = 0; i < d.numSupportedMorphTargets;) h[i] ? (j = h[i][0], k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[j]), k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[j]), k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0)), f.__webglMorphTargetInfluences[i] = g[j]) : (k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0), f.__webglMorphTargetInfluences[i] = 0), i++
                }
            ...
            if (a) {
                ...
                0 <= b.lineDistance && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglLineDistanceBuffer), k.vertexAttribPointer(b.lineDistance, 1, k.FLOAT, !1, 0, 0))
            }
            f instanceof THREE.Mesh ? (d.wireframe ? (d = d.wireframeLinewidth, d !== Wa && (k.lineWidth(d), Wa = d), a && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.__webglLineBuffer), k.drawElements(k.LINES, e.__webglLineCount, k.UNSIGNED_SHORT, 0)) : (a && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer), k.drawElements(k.TRIANGLES, e.__webglFaceCount, k.UNSIGNED_SHORT, 0)), L.info.render.calls++, L.info.render.vertices += e.__webglFaceCount, L.info.render.faces += e.__webglFaceCount / 3) : f instanceof THREE.Line ? (f = f.type === THREE.LineStrip ? k.LINE_STRIP : k.LINES, d = d.linewidth, d !== Wa && (k.lineWidth(d), Wa = d), k.drawArrays(f, 0, e.__webglLineCount), L.info.render.calls++) : f instanceof THREE.ParticleSystem ? (k.drawArrays(k.POINTS, 0, e.__webglParticleCount), L.info.render.calls++, L.info.render.points += e.__webglParticleCount) : f instanceof THREE.Ribbon && (k.drawArrays(k.TRIANGLE_STRIP, 0, e.__webglVertexCount), L.info.render.calls++)
        }
    };
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsAdded.length;) {
            ...
            if (!b.__webglInit) if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, b instanceof THREE.Mesh) if (m = b.geometry, o = b.material, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    ...
                    q.geometryGroups = {};
                    u = 0;
                    for (v = q.faces.length; u < v; u++) A = q.faces[u], B = X ? A.materialIndex : void 0, D = void 0 !== B ? B : -1, void 0 === G[D] && (G[D] = {
                        hash: D,
                        counter: 0
            ...
            if (!b.__webglActive) {
                ...
                else b instanceof THREE.Ribbon || b instanceof THREE.Line || b instanceof THREE.ParticleSystem ? (m = b.geometry, s(l.__webglObjects, m, b)) : b instanceof THREE.ImmediateRenderObject || b.immediateRenderCallback ? l.__webglObjectsImmediate.push({
                    object: b,
                    opaque: null,
                    transparent: null
        ...
        for (; a.__objectsRemoved.length;) {
            var oa = a.__objectsRemoved[0],
                sa = a;
            oa instanceof THREE.Mesh || oa instanceof THREE.ParticleSystem || oa instanceof THREE.Ribbon || oa instanceof THREE.Line ? z(sa.__webglObjects, oa) : oa instanceof THREE.Sprite ? w(sa.__webglSprites, oa) : oa instanceof THREE.LensFlare ? w(sa.__webglFlares, oa) : (oa instanceof THREE.ImmediateRenderObject || oa.immediateRenderCallback) && z(sa.__webglObjectsImmediate, oa);
            oa.__webglActive = !1;
            ...
            if (qa instanceof THREE.Mesh) if (T instanceof THREE.BufferGeometry)(T.verticesNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate || T.tangentsNeedUpdate) && j(T, k.DYNAMIC_DRAW, !T.dynamic), T.verticesNeedUpdate = !1, T.elementsNeedUpdate = !1, T.uvsNeedUpdate = !1, T.normalsNeedUpdate = !1, T.colorsNeedUpdate = !1, T.tangentsNeedUpdate = !1;
                ...
                for (var Ka = 0, Oa = T.geometryGroupsList.length; Ka < Oa; Ka++) if (Ja = T.geometryGroupsList[Ka], ma = e(qa, Ja), T.buffersNeedUpdate && d(Ja, qa), va = ma.attributes && t(ma), T.verticesNeedUpdate || T.morphTargetsNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate || T.tangentsNeedUpdate || va) {
                    ...
                    if (ra.__inittedArrays) {
                        ...
                        if (cc.length) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) S = $a[ta[F]], Ob = cc[S.a], Pb = cc[S.b], Qb = cc[S.c], Ha[ha] = Ob.x, Ha[ha + 1] = Ob.y, Ha[ha + 2] = Ob.z, Ha[ha + 3] = Ob.w, Ha[ha + 4] = Pb.x, Ha[ha + 5] = Pb.y, Ha[ha + 6] = Pb.z, Ha[ha + 7] = Pb.w, Ha[ha + 8] = Qb.x, Ha[ha + 9] = Qb.y, Ha[ha + 10] = Qb.z, Ha[ha + 11] = Qb.w, Rb = fc[S.a], Sb = fc[S.b], Tb = fc[S.c], Ga[ha] = Rb.x, Ga[ha + 1] = Rb.y, Ga[ha + 2] = Rb.z, Ga[ha + 3] = Rb.w, Ga[ha + 4] = Sb.x, Ga[ha + 5] = Sb.y, Ga[ha + 6] = Sb.z, Ga[ha + 7] = Sb.w, Ga[ha + 8] = Tb.x, Ga[ha + 9] = Tb.y, Ga[ha + 10] = Tb.z, Ga[ha + 11] = Tb.w, ha += 12;
                            F = 0;
                            for ($ = ua.length; F < $; F++) S = $a[ua[F]], Ob = cc[S.a], Pb = cc[S.b], Qb = cc[S.c], Bb = cc[S.d], Ha[ha] = Ob.x, Ha[ha + 1] = Ob.y, Ha[ha + 2] = Ob.z, Ha[ha + 3] = Ob.w, Ha[ha + 4] = Pb.x, Ha[ha + 5] = Pb.y, Ha[ha + 6] = Pb.z, Ha[ha + 7] = Pb.w, Ha[ha + 8] = Qb.x, Ha[ha + 9] = Qb.y, Ha[ha + 10] = Qb.z, Ha[ha + 11] = Qb.w, Ha[ha + 12] = Bb.x, Ha[ha + 13] = Bb.y, Ha[ha + 14] = Bb.z, Ha[ha + 15] = Bb.w, Rb = fc[S.a], Sb = fc[S.b], Tb = fc[S.c], Cb = fc[S.d], Ga[ha] = Rb.x, Ga[ha + 1] = Rb.y, Ga[ha + 2] = Rb.z, Ga[ha + 3] = Rb.w, Ga[ha + 4] = Sb.x, Ga[ha + 5] = Sb.y, Ga[ha + 6] = Sb.z, Ga[ha + 7] = Sb.w, Ga[ha + 8] = Tb.x, Ga[ha + 9] = Tb.y, Ga[ha + 10] = Tb.z, Ga[ha + 11] = Tb.w, Ga[ha + 12] = Cb.x, Ga[ha + 13] = Cb.y, Ga[ha + 14] = Cb.z, Ga[ha + 15] = Cb.w, ha += 16;
                        ...
                        if (hd && rb) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) S = $a[ta[F]], Eb = S.vertexColors, pb = S.color, 3 === Eb.length && rb === THREE.VertexColors ? (Lb = Eb[0], Mb = Eb[1], Nb = Eb[2]) : Nb = Mb = Lb = pb, Va[Ma] = Lb.r, Va[Ma + 1] = Lb.g, Va[Ma + 2] = Lb.b, Va[Ma + 3] = Mb.r, Va[Ma + 4] = Mb.g, Va[Ma + 5] = Mb.b, Va[Ma + 6] = Nb.r, Va[Ma + 7] = Nb.g, Va[Ma + 8] = Nb.b, Ma += 9;
                            F = 0;
                        ...
                        if (Qc && fb.hasTangents) {
                            ...
                            F = 0;
                            for ($ = ua.length; F < $; F++) S = $a[ua[F]], Vb = S.vertexTangents, Fb = Vb[0], Gb = Vb[1], Hb = Vb[2], qb = Vb[3], Fa[Ba] = Fb.x, Fa[Ba + 1] = Fb.y, Fa[Ba + 2] = Fb.z, Fa[Ba + 3] = Fb.w, Fa[Ba + 4] = Gb.x, Fa[Ba + 5] = Gb.y, Fa[Ba + 6] = Gb.z, Fa[Ba + 7] = Gb.w, Fa[Ba + 8] = Hb.x, Fa[Ba + 9] = Hb.y, Fa[Ba + 10] = Hb.z, Fa[Ba + 11] = Hb.w, Fa[Ba + 12] = qb.x, Fa[Ba + 13] = qb.y, Fa[Ba + 14] = qb.z, Fa[Ba + 15] = qb.w, Ba += 16;
                            k.bindBuffer(k.ARRAY_BUFFER, ra.__webglTangentBuffer);
                            k.bufferData(k.ARRAY_BUFFER, Fa, Ea)
                        }
                        if (Pc && mb) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) if (S = $a[ta[F]], eb = S.vertexNormals, bb = S.normal, 3 === eb.length && lb) for (wa = 0; 3 > wa; wa++) ac = eb[wa], wb[Za] = ac.x, wb[Za + 1] = ac.y, wb[Za + 2] = ac.z, Za += 3;
                        ...
                        if (oc && Wc && ob) {
                            ...
                            F = 0;
                            for ($ = ua.length; F < $; F++) if (ab = ua[F], kb = Wc[ab], void 0 !== kb) for (wa = 0; 4 > wa; wa++) lc = kb[wa], qc[Yb] = lc.u, qc[Yb + 1] = lc.v, Yb += 2;
                        ...
                        if (Uc) {
                            ...
                            for (gc = Uc.length; wa < gc; wa++) if (x = Uc[wa], x.__original.needsUpdate) {
                                ...
                                if (1 === x.size) if (void 0 === x.boundTo || "vertices" === x.boundTo) {
                                    ...
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) S = $a[ua[F]], x.array[y] = x.value[S.a], x.array[y + 1] = x.value[S.b], x.array[y + 2] = x.value[S.c], x.array[y + 3] = x.value[S.d], y += 4
                                } else {
                                    if ("faces" === x.boundTo) {
                                        F = 0;
                                    ...
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) S = $a[ta[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = V.x, x.array[y + 3] = V.y, x.array[y + 4] = W.x, x.array[y + 5] = W.y, y += 6;
                                    F = 0;
                                    ...
                                    if ("faces" === x.boundTo) {
                                        F = 0;
                                        for ($ = ta.length; F < $; F++) W = V = U = ya = x.value[ta[F]], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = V.x, x.array[y + 3] = V.y, x.array[y + 4] = W.x, x.array[y + 5] = W.y, y += 6;
                                        F = 0;
                                    ...
                                    if (void 0 === x.boundTo || "vertices" === x.boundTo) {
                                        ...
                                        F = 0;
                                        for ($ = ua.length; F < $; F++) pa = W = V = U = ya = x.value[ua[F]], x.array[y] = U[ea[0]], x.array[y + 1] = U[ea[1]], x.array[y + 2] = U[ea[2]], x.array[y + 3] = V[ea[0]], x.array[y + 4] = V[ea[1]], x.array[y + 5] = V[ea[2]], x.array[y + 6] = W[ea[0]], x.array[y + 7] = W[ea[1]], x.array[y + 8] = W[ea[2]], x.array[y + 9] = pa[ea[0]], x.array[y + 10] = pa[ea[1]], x.array[y + 11] = pa[ea[2]], y += 12
                                    ...
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) S = $a[ta[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, y += 12;
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) S = $a[ua[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], pa = x.value[S.d], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, x.array[y + 12] = pa.x, x.array[y + 13] = pa.y, x.array[y + 14] = pa.z, x.array[y + 15] = pa.w, y += 16
                                } else if ("faces" === x.boundTo) {
                                    F = 0;
                                    ...
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) pa = W = V = U = ya = x.value[ua[F]], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, x.array[y + 12] = pa.x, x.array[y + 13] = pa.y, x.array[y + 14] = pa.z, x.array[y + 15] = pa.w, y += 16
                                } else if ("faceVertices" === x.boundTo) {
                                    F = 0;
                                    ...
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) ya = x.value[ua[F]], U = ya[0], V = ya[1], W = ya[2], pa = ya[3], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, x.array[y + 12] = pa.x, x.array[y + 13] = pa.y, x.array[y + 14] = pa.z, x.array[y + 15] = pa.w, y += 16
                                }
                                k.bindBuffer(k.ARRAY_BUFFER, x.buffer);
                                k.bufferData(k.ARRAY_BUFFER, x.array, Ea)
                            }
                        }
                        ib && (delete ra.__inittedArrays, delete ra.__colorArray, delete ra.__normalArray, delete ra.__tangentArray, delete ra.__uvArray, delete ra.__uv2Array, delete ra.__faceArray, delete ra.__vertexArray, delete ra.__lineArray, delete ra.__skinIndexArray, delete ra.__skinWeightArray)
                    }
                }
                ...
                if (T.verticesNeedUpdate || T.colorsNeedUpdate || T.normalsNeedUpdate || va) {
                    var xb = T,
                        Bc = k.DYNAMIC_DRAW,
                        rc = void 0,
                        sc = void 0,
                    ...
                    if (Xc) {
                        Fc = 0;
                        for (Zc = Xc.length; Fc < Zc; Fc++) if (Ca = Xc[Fc], Ca.needsUpdate && (void 0 === Ca.boundTo || "vertices" === Ca.boundTo)) {
                            za = 0;
                            mc = Ca.value.length;
                            ...
                            else if (4 === Ca.size) for (Xa = 0; Xa < mc; Xa++) gb = Ca.value[Xa], Ca.array[za] = gb.x, Ca.array[za + 1] = gb.y, Ca.array[za + 2] = gb.z, Ca.array[za + 3] = gb.w, za += 4;
                ...
                if (T.verticesNeedUpdate || T.colorsNeedUpdate || T.lineDistancesNeedUpdate || va) {
                    ...
                    if (Yc) {
                        ...
                        for (gd = Yc.length; Oc < gd; Oc++) if (Da = Yc[Oc], Da.needsUpdate && (void 0 === Da.boundTo || "vertices" === Da.boundTo)) {
                            ...
                            else if (2 === Da.size) for (Ya = 0; Ya < nc; Ya++) hb = Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Ia += 2;
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        m = p;
        hc && d && d.useVertexTexture ? l = 1024 : (b = k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS), b = Math.floor((b - 20) / 4), void 0 !== d && d instanceof THREE.SkinnedMesh && (b = Math.min(d.bones.length, b), b < d.bones.length && console.warn("WebGLRenderer: too many bones - " + d.bones.length + ", this GPU supports just " + b + " (try OpenGL instead of ANGLE)")), l = b);
        var q;
        a: {
            s = a.fragmentShader;
            r = a.vertexShader;
        ...
        if (a.morphNormals) {
            ...
            v = "morphNormal";
            for (j = 0; j < this.maxMorphNormals; j++) w = v + j, 0 <= q[w] && (k.enableVertexAttribArray(q[w]), a.numSupportedMorphNormals++)
        }
        a.uniformsList = [];
    ...
    this.setBlending = function (a, b, c, d) {
        a !== ma && (a === THREE.NoBlending ? k.disable(k.BLEND) : a === THREE.AdditiveBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.SRC_ALPHA, k.ONE)) : a === THREE.SubtractiveBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.ONE_MINUS_SRC_COLOR)) : a === THREE.MultiplyBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.SRC_COLOR)) : a === THREE.CustomBlending ? k.enable(k.BLEND) : (k.enable(k.BLEND), k.blendEquationSeparate(k.FUNC_ADD, k.FUNC_ADD), k.blendFuncSeparate(k.SRC_ALPHA, k.ONE_MINUS_SRC_ALPHA, k.ONE, k.ONE_MINUS_SRC_ALPHA)), ma = a);
    ...
    this.setRenderTarget = function (a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            } else a.__webglFramebuffer = k.createFramebuffer(), a.__webglRenderbuffer = k.createRenderbuffer(), k.bindTexture(k.TEXTURE_2D, a.__webglTexture), P(k.TEXTURE_2D, a, c), k.texImage2D(k.TEXTURE_2D, 0, d, a.width, a.height, 0, d, e, null), d = k.TEXTURE_2D, k.bindFramebuffer(k.FRAMEBUFFER, a.__webglFramebuffer), k.framebufferTexture2D(k.FRAMEBUFFER, k.COLOR_ATTACHMENT0, d, a.__webglTexture, 0), B(a.__webglRenderbuffer, a), c && k.generateMipmap(k.TEXTURE_2D);
        ...
        b !== ca && (k.bindFramebuffer(k.FRAMEBUFFER, b), k.viewport(d, e, c, a), ca = b);
        lb = c;
        ab = a
    };
...
THREE.GeometryUtils = {
    merge: function (a, b) {
        ...
        for (n = j.length; m < n; m++) {
            var p = j[m],
                o, s, t = p.vertexNormals,
                r = p.vertexColors;
            p instanceof THREE.Face3 ? o = new THREE.Face3(p.a + e, p.b + e, p.c + e) : p instanceof THREE.Face4 && (o = new THREE.Face4(p.a + e, p.b + e, p.c + e, p.d + e));
    ...
    randomPointsInGeometry: function (a, b) {
        ...
        var d, e, f = a.faces,
            ...
            j = [],
            l, m, n, p;
        for (e = 0; e < h; e++) d = f[e], d instanceof THREE.Face3 ? (l = g[d.a], m = g[d.b], n = g[d.c], d._area = THREE.GeometryUtils.triangleArea(l, m, n)) : d instanceof THREE.Face4 && (l = g[d.a], m = g[d.b], n = g[d.c], p = g[d.d], d._area1 = THREE.GeometryUtils.triangleArea(l, m, p), d._area2 = THREE.GeometryUtils.triangleArea(m, n, p), d._area = d._area1 + d._area2), i += d._area, j[e] = i;
        d = [];
    ...
    tessellate: function (a, b) {
        var c, d, e, f, g, h, i, j, l, m, n, p, o, s, t, r, z, w, q, E = [],
            A = [];
        c = 0;
    ...
    getNormalMap: function (a, b) {
        ...
        for (var h = g.getImageData(0, 0, d, e).data, i = g.createImageData(d, e), j = i.data, l = 0; l < d; l++) for (var m = 0; m < e; m++) {
            ...
            for (p = 0; p < o; p++) {
                ...
                n.push(c([s[1] * z[2] - s[2] * z[1], s[2] * z[0] - s[0] * z[2], s[0] * z[1] - s[1] * z[0]]))
            }
            t = [0, 0, 0];
...
THREE.FontUtils = {
    ...
    extractGlyphPoints: function (a, b, c, d, e) {
        var f = [],
            g, h, i, j, l, m, n, p, o, s, t, r = b.glyphs[a] || b.glyphs["?"];
        if (r) {
            if (r.o) {
...
THREE.Path.prototype.getPoints = function (a, b) {
    ...
    case THREE.PathActions.ELLIPSE:
        ...
        p = g - j;
        o = 2 * a;
        for (f = 1; f <= o; f++) s = f / o, m || (s = 1 - s), s = j + s * p, g = h + n * Math.cos(s), s = i + l * Math.sin(s), c.push(new THREE.Vector2(g, s))
    }
    d = c[c.length - 1];
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    c = (b - a) / c;
    for (h = 0; h < d; h++) {
        0 !== a ? (m = this.vertices[j[0][h]].clone(), n = this.vertices[j[0][h + 1]].clone()) : (m = this.vertices[j[1][h]].clone(), n = this.vertices[j[1][h + 1]].clone());
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    var h = void 0 !== b.amount ? b.amount : 100,
        ...
        w, q, E, A;
    p && (o = p.getSpacedPoints(n), s = !0, m = !1, w = void 0 !== b.frames ? b.frames : new THREE.TubeGeometry.FrenetFrames(p, n, !1), q = new THREE.Vector3, E = new THREE.Vector3, A = new THREE.Vector3);
    m || (j = i = l = 0);
    var v, u, D, C = this,
    ...
    I = j;
    for (J = 0; J < R; J++) O = m ? c(P[J], oa[J], I) : P[J], s ? (E.copy(w.normals[0]).multiplyScalar(O.x), q.copy(w.binormals[0]).multiplyScalar(O.y), A.copy(o[0]).addSelf(E).addSelf(q), f(A.x, A.y, A.z)) : f(O.x, O.y, 0);
    ...
    for (H = l - 1; 0 <= H; H--) {
        ...
        for (D = p.length; u < D; u++) {
            ...
            L = Z[u];
            J = 0;
            for (Q = v.length; J < Q; J++) O = c(v[J], L[J], I), s ? f(O.x, O.y + o[n - 1].y, o[n - 1].x + N) : f(O.x, O.y, h + N)
        }
    }
    if (m) {
        i = 0 * R;
...
THREE.LatheGeometry = function (a, b, c) {
    ...
    for (c = 0; c < b; c++) {
        d = 0;
        for (e = a.length; d < e - 1; d++) this.faces.push(new THREE.Face4(c * e + d, (c + 1) % g * e + d, (c + 1) % g * e + (d + 1) % e, c * e + (d + 1) % e)), this.faceVertexUvs[0].push([new THREE.UV(1 - c / b, d / e), new THREE.UV(1 - (c + 1) / b, d / e), new THREE.UV(1 - (c + 1) / b, (d + 1) / e), new THREE.UV(1 - c / b, (d + 1) / e)])
    }
    this.computeCentroids();
    this.computeFaceNormals();
...
THREE.PlaneGeometry = function (a, b, c, d) {
    ...
    for (a = 0; a < f; a++) for (b = 0; b < d; b++) c = new THREE.Face4(b + g * a, b + g * (a + 1), b + 1 + g * (a + 1), b + 1 + g * a), c.normal.copy(l), c.vertexNormals.push(l.clone(), l.clone(), l.clone(), l.clone()), this.faces.push(c), this.faceVertexUvs[0].push([new THREE.UV(b / d, 1 - a / f), new THREE.UV(b / d, 1 - (a + 1) / f), new THREE.UV((b + 1) / d, 1 - (a + 1) / f), new THREE.UV((b + 1) / d, 1 - a / f)]);
    this.computeCentroids()
};
...
THREE.ParametricGeometry = function (a, b, c, d) {
    ...
    var n, p, o, s;
    for (h = 0; h < c; h++) for (i = 0; i < b; i++) a = h * m + i, e = h * m + i + 1, l = (h + 1) * m + i, j = (h + 1) * m + i + 1, n = new THREE.UV(i / b, h / c), p = new THREE.UV((i + 1) / b, h / c), o = new THREE.UV(i / b, (h + 1) / c), s = new THREE.UV((i + 1) / b, (h + 1) / c), d ? (f.push(new THREE.Face3(a, e, l)), f.push(new THREE.Face3(e, j, l)), g.push([n, p, o]), g.push([p, s, o])) : (f.push(new THREE.Face4(a, e, j, l)), g.push([n, p, s, o]));
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
};
...
THREE.SubdivisionModifier.prototype.smooth = function (a) {
    ...
    function e(a, b, d, e, g, h, m) {
        ...
        if (l.useOldVertexColors) {
            ...
            for (var o, p, q, r = 0; 4 > r; r++) {
                ...
                o = new THREE.Color;
                o.setRGB(0, 0, 0);
                for (var s = 0; s < q.length; s++) p = g.vertexColors[q[s] - 1], o.r += p.r, o.g += p.g, o.b += p.b;
                o.r /= q.length;
                o.g /= q.length;
                o.b /= q.length;
                n.vertexColors[r] = o
    ...
    q = 0;
    for (E = o.length; q < E; q++) u = o[q], t.push(u.centroid), h.push(u.centroid), l.supportUVs && (v = new THREE.UV, u instanceof THREE.Face3 ? (v.u = f(u.a, q).u + f(u.b, q).u + f(u.c, q).u, v.v = f(u.a, q).v + f(u.b, q).v + f(u.c, q).v, v.u /= 3, v.v /= 3) : u instanceof THREE.Face4 && (v.u = f(u.a, q).u + f(u.b, q).u + f(u.c, q).u + f(u.d, q).u, v.v = f(u.a, q).v + f(u.b, q).v + f(u.c, q).v + f(u.d, q).v, v.u /= 4, v.v /= 4), g(s + q, "", v));
    var n = n(a),
        P;
    E = 0;
    var B, K;
    ...
    var H = ["123", "31", "1", "12"],
        ...
        M = ["1234", "41", "1", "12"];
    q = 0;
    for (E = t.length; q < E; q++) u = o[q], C = s + q, u instanceof THREE.Face3 ? (K = m(u.a, u.b), B = m(u.b, u.c), N = m(u.c, u.a), e(C, r[K], u.b, r[B], u, v, q), e(C, r[B], u.c, r[N], u, P, q), e(C, r[N], u.a, r[K], u, H, q)) : u instanceof THREE.Face4 ? (K = m(u.a, u.b), B = m(u.b, u.c), N = m(u.c, u.d), O = m(u.d, u.a), e(C, r[K], u.b, r[B], u, I, q), e(C, r[B], u.c, r[N], u, R, q), e(C, r[N], u.d, r[O], u, ga, q), e(C, r[O], u.a, r[K], u, M, q)) : c("face should be a face!", u);
    r = new THREE.Vector3;
    u = new THREE.Vector3;
    q = 0;
    ...
    this.render = function (a, d, e, r) {
        ...
        if (z) {
            ...
            for (P = 0; P < z; P++) if (v = 16 / r, u.set(v * q, v), H = a[P], w.set(H.matrixWorld.elements[12], H.matrixWorld.elements[13], H.matrixWorld.elements[14]), d.matrixWorldInverse.multiplyVector3(w), d.projectionMatrix.multiplyVector3(w), D.copy(w), C.x = D.x * E + E, C.y = D.y * A + A, j || 0 < C.x && C.x < e && 0 < C.y && C.y < r) {
                ...
                b.enable(b.BLEND);
                B = 0;
                for (K = H.lensFlares.length; B < K; B++) I = H.lensFlares[B], 0.001 < I.opacity && 0.001 < I.scale && (D.x = I.x, D.y = I.y, D.z = I.z, v = I.size * I.scale / r, u.x = v * q, u.y = v, b.uniform3f(G.screenPosition, D.x, D.y, D.z), b.uniform2f(G.scale, u.x, u.y), b.uniform1f(G.rotation, I.rotation), b.uniform1f(G.opacity, I.opacity), b.uniform3f(G.color, I.color.r, I.color.g, I.color.b), c.setBlending(I.blending, I.blendEquation, I.blendSrc, I.blendDst), c.setTexture(I.texture, 1), b.drawElements(b.TRIANGLES, 6, b.UNSIGNED_SHORT, 0))
            }
...
THREE.SpritePlugin = function () {
    ...
    this.render = function (d, e, p, o) {
        ...
        if (t) {
            ...
            var A = r = 0,
                v = d.fog;
            v ? (b.uniform3f(z.fogColor, v.color.r, v.color.g, v.color.b), v instanceof THREE.Fog ? (b.uniform1f(z.fogNear, v.near), b.uniform1f(z.fogFar, v.far), b.uniform1i(z.fogType, 1), A = r = 1) : v instanceof THREE.FogExp2 && (b.uniform1f(z.fogDensity, v.density), b.uniform1i(z.fogType, 2), A = r = 2)) : (b.uniform1i(z.fogType, 0), A = r = 0);
            ...
            s.sort(a);
            for (v = 0; v < t; v++) if (u = s[v], u.visible && 0 !== u.opacity && u.map && u.map.image && u.map.image.width) u.useScreenCoordinates ? (b.uniform1i(z.useScreenCoordinates, 1), b.uniform3f(z.screenPosition, (u.position.x - p) / p, (q - u.position.y) / q, Math.max(0, Math.min(1, u.position.z)))) : (b.uniform1i(z.useScreenCoordinates, 0), b.uniform1i(z.affectedByDistance, u.affectedByDistance ? 1 : 0), b.uniformMatrix4fv(z.modelViewMatrix, !1, u._modelViewMatrix.elements)), e = d.fog && u.fog ? A : 0, r !== e && (b.uniform1i(z.fogType, e), r = e), e = 1 / (u.scaleByViewport ? o : 1), D[0] = e * w * u.scale.x, D[1] = e * u.scale.y, b.uniform2f(z.uvScale, u.uvScale.x, u.uvScale.y), b.uniform2f(z.uvOffset, u.uvOffset.x, u.uvOffset.y), b.uniform2f(z.alignment, u.alignment.x, u.alignment.y), b.uniform1f(z.opacity, u.opacity), b.uniform3f(z.color, u.color.r, u.color.g, u.color.b), b.uniform1f(z.rotation, u.rotation), b.uniform2fv(z.scale, D), u.mergeWith3D && !E ? (b.enable(b.DEPTH_TEST), E = !0) : !u.mergeWith3D && E && (b.disable(b.DEPTH_TEST), E = !1), c.setBlending(u.blending, u.blendEquation, u.blendSrc, u.blendDst), c.setTexture(u.map, 0), b.drawElements(b.TRIANGLES, 6, b.UNSIGNED_SHORT, 0);
            b.enable(b.CULL_FACE);
            b.enable(b.DEPTH_TEST);
            b.depthMask(!0)
        }
...
THREE.DepthPassPlugin = function () {
    ...
    this.update = function (i, j) {
        ...
        j._projectionMatrixArray || (j._projectionMatrixArray = new Float32Array(16));
        ...
        s = i.__webglObjects;
        l = 0;
        for (m = s.length; l < m; l++) if (n = s[l], o = n.object, n.render = !1, o.visible && (!(o instanceof THREE.Mesh || o instanceof THREE.ParticleSystem) || !o.frustumCulled || g.contains(o))) o._modelViewMatrix.multiply(j.matrixWorldInverse, o.matrixWorld), n.render = !0;
        var t;
        l = 0;
